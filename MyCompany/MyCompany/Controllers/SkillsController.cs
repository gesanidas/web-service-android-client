...
namespace MyCompany.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public SkillsController(MyCompanyContext context)
        {
            _context = context;    
        }
        ...
        {
            var myCompanyContext = _context.Skill.Include(s => s.Employee);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SkillID,EmployeeID,Description")] Skill skill)
        {
            if (id != skill.SkillID)
            {
                return NotFound();
